...
var AppComponent = /** @class */ (function () {
    function AppComponent(db) {
        ...
        db.object('/distance').valueChanges()
            ...
            _this.percent = Number(_this.distance) / 125 * 100;
        });
    ...
    AppComponent.prototype.color = function (distance) {
        if ((distance / 125 * 100) > 90) {
            return "#c00000";
        }
        else if ((distance / 125 * 100) > 70) {
            return "#c04200";
        }
        else if ((distance / 125 * 100) > 50) {
            return "#c08400";
        }
        else if ((distance / 125 * 100) > 30) {
            return "#c0c000";
        }
        else {
            return "#76c000";
